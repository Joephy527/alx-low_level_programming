...
Project done during **Full Stack Software Engineering studies** at **ALX and Holberton School**. It aims to learn about dynamic and shared libraries in **C language**.
